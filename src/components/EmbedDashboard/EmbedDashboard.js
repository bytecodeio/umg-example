  ...
  const embedDashboard = useCallback(
    (embedContainer) => {
      ...
      if (embedContainer && dashboardId && hostUrl) {
        ...
        const embedUrl = `${hostUrl}/embed/dashboards/${dashboardId}?theme=umg&_theme={"show_filters_bar":false, "show_title":true}&embed_domain=${hostUrl}&sdk=2&sandboxed_host=true`;
